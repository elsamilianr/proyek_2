...
<div class="form-page">
    <h2 class="form-title">formulir edit stok</h2>
    ...
    <form action="{{ route('karyawan.varian.update', $stok->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-input" type="date" name="tanggal_restok"
                value="{{ old('tanggal_restok', $stok->tanggal_restok) }}" required style="cursor:pointer;">
        </div>

        <button type="submit" class="form-btn">Update Stok</button>
    </form>
</div>
