...
<div class="page-header" style="margin-bottom:24px;">
    <div style="display:flex;align-items:center;gap:14px;">
        ...
        <h1 class="page-title" style="margin:0;">Detail Transaksi Offline</h1>
    </div>
    <a href="{{ route('karyawan.transaksi.struk', $transaksi->id) }}"
       style="display:flex;align-items:center;gap:8px;background:var(--pink-btn);color:white;
    ...
    <div class="detail-card">
        ...
        <div class="info-grid">
            <div>
                ...
                <div class="info-value">{{ $transaksi->karyawan?->nama ?? $transaksi->karyawan?->name ?? '-' }}</div>
            </div>
            <div>
                <div class="info-label">Metode Pembayaran</div>
                <div class="info-value">
                    <span class="badge-method">{{ $transaksi->label_metode }}</span>
                </div>
            </div>
            @if($transaksi->midtrans_order_id)
            <div>
                <div class="info-label">ID Pembayaran Midtrans</div>
                <div class="info-value" style="font-size:14px;color:var(--pink-btn);">
            ...
            <div>
                ...
                <div class="info-value" style="color:var(--pink-btn);">
                    {{ $transaksi->promo->kode }} — {{ $transaksi->promo->nama_promo }}
                </div>
            </div>
            @endif
        </div>
            ...
            <div style="margin-top:16px;">
                ...
                <div class="summary-row">
                    <span style="color:#64748b;">
                        Diskon
                        @if($transaksi->promo)
                            <small style="font-weight:600;">({{ $transaksi->promo->kode }})</small>
                        @endif
                    </span>
        ...
        <div class="detail-card">
            ...
            <div style="display:flex;flex-direction:column;gap:16px;">
                <div>
                    ...
                    <div class="info-value" style="font-size:15px;">{{ $transaksi->label_metode }}</div>
                </div>
                <div>
                ...
                <div style="background:#f0fdf4;border-radius:12px;padding:12px 14px;
                            font-size:13px;color:#16a34a;font-weight:700;text-align:center;">
