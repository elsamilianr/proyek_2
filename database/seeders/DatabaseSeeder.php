...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // ── Users (skip jika username sudah ada) ──────────────────────────────────
        ...
        $pembeli = User::firstOrCreate(['username' => 'pembeli'], [
            'nama'     => 'Pembeli Contoh',
        ...
        Keranjang::firstOrCreate(['id_user' => $pembeli->id]);

        // ── Produk & Varian (skip jika sudah ada) ─────────────────────────────────
        if (Produk::count() > 0) return;
        ...
        $katalog = [
            ...
            [
                ...
                'varians'     => [
                    ...
                    ['warna' => 'Abu',   'size' => 'Free Size', 'harga' => 25000, 'stok' => 10],
                ],
            ],
        ];
